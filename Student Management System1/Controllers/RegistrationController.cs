...
namespace Student_Management_System1.Controllers
{
    public class RegistrationController : Controller
    {
        ...
        {
            ViewBag.batch_id = new SelectList(db.master2, "id", "batch1");
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id,telno")] registration registration)
        {
            ...
            ViewBag.batch_id = new SelectList(db.master2, "id", "batch1", registration.batch_id);
